...
PREDICTIONS_COLUMNS = [
    ...
    "away_pitch_eff_ppi",
    "home_pitch_eff_ppi",
    "away_pitch_eff_starts",
    "home_pitch_eff_starts",
    # ---- wind direction ----
    "wind_dir",
    "wind_effect_label",
    "wind_component_out",
...
def _row_from_game(prediction_date: str, g: dict) -> dict:
    ...
    return {
        ...
        "away_pitch_eff_ppi": (g.get("away_pitch_eff") or {}).get("avg_pitches_per_inning", ""),
        "home_pitch_eff_ppi": (g.get("home_pitch_eff") or {}).get("avg_pitches_per_inning", ""),
        "away_pitch_eff_starts": (g.get("away_pitch_eff") or {}).get("starts_sample", ""),
        "home_pitch_eff_starts": (g.get("home_pitch_eff") or {}).get("starts_sample", ""),
